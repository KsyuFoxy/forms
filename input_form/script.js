...
var inputValue = document.getElementsByTagName("input");
  function validateForm() {
     // textarea field
    var customerText = document.querySelector('textarea').value;
    ...
    for (x = 0; x < inputValue.length; x++) {
        ...
        if (reqName.indexOf("f") == 0) {
            ...
            if (requiredField == '') {
                formResults.innerHTML = 'Name and Email must be filled out';
                formResults.style.color =  'red';
                return false;
            }
            if( customerText === '') {
                   formResults.innerHTML = 'Text must be filled out';
                   formResults.style.color =  'red';
                   return false;
               }
           }
...
// array of services that were chosen by customer
    ...
    formResults.innerHTML = 'Name: ' + person.fname +"<br>"+ 'Email: ' + person.femail +"<br>"+ 'Title: ' + person.title +"<br>"+ 'Country: '+
                            person.country +"<br>"+'Region: ' + person.region + "<br>"+ 'Your text: ' + customerText + "<br>"+ 'Chosen services: ' + services;
...
function changeformBGHeight() {
    ...
    document.getElementById('formBG').style.height = formHeight + 'px';
